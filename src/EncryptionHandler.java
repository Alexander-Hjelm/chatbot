...
public class EncryptionHandler {
	...
	public String encrypt(byte[] byteInput) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException,
	...
	public byte[] decrypt(String inputString) throws InvalidKeyException, IllegalBlockSizeException,
	...
	private String aesEncrypt(byte[] byteInput) throws InvalidKeyException, IllegalBlockSizeException,
			BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
	...
	private byte[] aesDecrypt(String encryptedHexString) throws InvalidKeyException, IllegalBlockSizeException,
			BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
		SecretKey secKey = aesStringToKey(thisKey);
